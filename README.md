...
```js
git clone https://github.com/GustavoSantOliveira/Projeto_Chatbot_NodeJs.git
```
...
### Pronto, se realizado todos os passos listados até aqui, seu chatbot estará funcionando corretamente!!!

Em caso de dúvidas, entre em contato nos e-mails abaixo:

Gustavo Oliveira <gustavosantana86@hotmail.com>
